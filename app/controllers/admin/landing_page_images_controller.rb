class Admin::LandingPageImagesController < Admin::BaseController
  ...
  def collection_path
    admin_landing_page_images_path(parent)
  end

  def resource_path(_resource)
    admin_landing_page_image_path(parent, _resource)
  end

  def new_resource_path
    new_admin_landing_page_image_path(parent)
  end

  def edit_resource_path(_resource)
    edit_admin_landing_page_image_path(parent, _resource)
  end

  def toggle_visibility_resource_path(_resource)
    toggle_visibility_admin_landing_page_image_path(parent, _resource)
  end

  def sort_collection_path
    sort_admin_landing_page_images_path(parent)
  end
end
